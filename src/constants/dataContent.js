const dataContent = {
  ...
  convenienceAndLicensingSection: {
    header: {
      description: 'Best-in-class support',
    ...
    image: 'convenience-and-licensing-image',
    cards: [
      {
        icon: 'rocket',
  ...
  frequentlyAskedSection: {
    header: {
      ...
      text: 'Choose any questions you need',
    },
    listFAQ: [
      {
